...
public class ServerSpinnerAdapter extends ArrayAdapter<Server> {
    ...
    public ServerSpinnerAdapter(Context context, Collection<Server> servers) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(String.format("%s : %s", getContext().getString(R.string.server), getItem(position).getName()));
        return convertView;
    }
